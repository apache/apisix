...
| brokers.port                     | integer | 是       |                 | [0, 65535]                                        | Kafka broker 的节点端口。                                                                                                                                                                                                                                                     |
...
| cluster_name                     | integer | 否       | 1               | [0,...]                                           | Kafka 集群的名称，在有两个或多个 Kafka 集群时使用。仅当 `producer_type` 设置为 `async` 时有效。                                                                                                                                                                               |
...
以下示例演示了如何使用[插件元数据](../terminology/plugin.md)和[内置变量](../apisix-variable.md)自定义日志格式，以记录请求和响应中的特定头字段。
