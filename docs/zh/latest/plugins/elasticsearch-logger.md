...
| auth.password | string | 否 | | Elasticsearch [身份验证](https://www.elastic.co/guide/en/elasticsearch/reference/current/setting-up-authentication.html) 密码。该密钥在存储到 etcd 之前会使用 AES 加密。 |
