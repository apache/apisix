...
- :warning: 不再兼容 OpenResty 1.19 版本，需要将其升级到 1.21+: [#9913](https://github.com/apache/apisix/pull/9913)
- :warning: 删除配置项 `apisix.stream_proxy.only`，L4/L7 代理需要通过配置项 `apesix.proxy_mode`: [#9607](https://github.com/apache/apisix/pull/9607)
...
- :sunrise: admin-api 新增 schema validate API  [#10065](https://github.com/apache/apisix/pull/10065)
...
- :sunrise: google-cloud-logging 插件支持配置 client_email: [#9813](https://github.com/apache/apisix/pull/9813)
...
- 修复使用 limit-count 插件时，当请求被拒绝后，X-RateLimit-Reset不应设置为0: [#9978](https://github.com/apache/apisix/pull/9978)
