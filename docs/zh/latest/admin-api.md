...
以下特性需要 APISIX 运行于 [APISIX-Base](./how-to-build.md#步骤6：为-apache-apisix-构建-openresty)：
...
这个特性需要 APISIX 运行于 [APISIX-Base](./how-to-build.md#步骤6：为-apache-apisix-构建-openresty)。
