...
| redis_username          | string  | False                                     |               |                                        | Username of the Redis server. Used when the `policy` is set to `redis`.                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| redis_ssl_verify        | boolean | False                                     | false         |                                        | If set to `true`, then verifies the validity of the server SSL certificate. Used when the `policy` attribute is set to `redis`. See [https://github.com/openresty/lua-nginx-module#tcpsocksslhandshake](https://github.com/openresty/lua-nginx-module#tcpsocksslhandshake).                                                                                                                                                                                                                                                                                                                                                                                                          |
