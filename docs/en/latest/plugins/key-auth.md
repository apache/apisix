...
|--------|--------|-------------|---------|-------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| var_combination | string | optional |      |    | Set which variable combination we get the key from. For example, "$remote_addr $consumer_name" will be combined into a key after parsing. highest priority.                  |
| header | string | optional    | apikey  |       | The header to get the key from. Lower priority than `var_combination`.                                                                                                                                                                                                                                              |
