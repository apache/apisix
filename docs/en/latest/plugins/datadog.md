...
| batch_max_size | integer | False    | 1000    | [1,...]        | Maximum number of log entries per batch. Once reached, the batch is sent to the Datadog agent. Set to `1` for immediate processing. |
| inactive_timeout | integer | False  | 5       | [1,...]        | Maximum time in seconds to wait for new entries before sending the batch. The value should be smaller than `buffer_duration`. |
...
| max_retry_count | integer | False   | 60      | [0,...]        | Maximum number of unsuccessful retries before dropping the entries.                                                      |
