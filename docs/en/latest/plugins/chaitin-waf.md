...
| config.connect_timeout   | integer       | false    | 1000                        | connect timeout, in milliseconds, integer, default 1s (1000ms)                                                               |
| config.send_timeout      | integer       | false    | 1000                        | send timeout, in milliseconds, integer, default 1s (1000ms)                                                                  |
| config.read_timeout      | integer       | false    | 1000                        | read timeout, in milliseconds, integer, default 1s (1000ms)                                                                  |
...
| config.send_timeout      | integer       | false    |               | send timeout, in milliseconds, integer                                                                                                                                                                                                                                                                                                                    |
| config.read_timeout      | integer       | false    |               | read timeout, in milliseconds, integer                                                                                                                                                                                                                                                                                                                    |
