...
| body_base64     | boolean | False    | false   |                                                                                                               | When set, the body passed in `body` will be decoded before writing to the client. Note that this field only allows decoding the body passed in plugin configuration and does not decode upstream response.                                                                                                                                                                                                       |
