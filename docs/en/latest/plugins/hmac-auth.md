...
The `Digest` header is included in the signature so the HMAC binds the body digest to the request body validated by APISIX.
...
```json
{
  ...
  "headers": {
    "Accept": "*/*",
    "Authorization": "Signature keyId=\"john-key\",algorithm=\"hmac-sha256\",headers=\"@request-target date\",signature=\"LGBTz7bVQQWlkijeyDpEwJWo+ppwX735uRZk5F8KhmU=\"",
    "Content-Length": "17",
