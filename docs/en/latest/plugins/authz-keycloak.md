...
| grant_type                                   | string        | False    | "urn:ietf:params:oauth:grant-type:uma-ticket" | ["urn:ietf:params:oauth:grant-type:uma-ticket", "urn:ietf:params:oauth:grant-type:token-exchange"]                    |  More details about token exchange are avaliable here https://www.keycloak.org/docs/latest/securing_apps/#_token-exchange                                                                                                                                                                                                                                                     |
...
| requested_token_type                         | string        | False    | "urn:ietf:params:oauth:grant-type:access_token" | ["urn:ietf:params:oauth:grant-type:access_token"]                    |                                                                                                                                                                                                                                                       |
| subject_issuer                                | string        | False    |                   |                  |                                 |
| requested_issuer                              | string        | False    |                   |                  | When your client is exchanging an existing internal token to an external one, you provide the requested_issuer parameter. The parameter must be the alias of a configured identity provider. |
...
Token exchange is the process of using a set of credentials or token to obtain an entirely different token. See [keycloak documentation](https://www.keycloak.org/docs/latest/securing_apps/#_token-exchange)
