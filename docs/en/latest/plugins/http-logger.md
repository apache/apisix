...
| max_req_body_bytes     | integer | False    | 524288        | >=1                  | Maximum request body allowed in bytes. Request bodies falling within this limit will be pushed to server. If the size exceeds the configured value, the body will be truncated before being pushed to server. |
...
| max_resp_body_bytes    | integer | False    | 524288        | >=1                  | Maximum response body allowed in bytes. Response bodies falling within this limit will be pushed to server. If the size exceeds the configured value, the body will be truncated before being pushed to server. |
