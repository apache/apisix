...
| redirect_after_logout_uri            | string  | False    |                      |              | Path for logging out.                                                                                                    |
| post_logout_redirect_uri             | string  | False    |                      |              | Where should the user be redirected after logout from the RP. This option overrides any end_session_endpoint that the OP may have provided in the discovery response.|
