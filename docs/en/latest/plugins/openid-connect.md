...
| session_contents.access_token   | boolean   | False    |     true     |             | If true, store the access token in the seesion.  |
| session_contents.id_token   | boolean   | False    |     true     |             | If true, store the ID token in the seesion.  |
| session_contents.enc_id_token   | boolean   | False    |     true     |             | If true, store the encrypted ID token in the seesion.  |
| session_contents.user   | boolean   | False    |     true     |             | If true, store the user info in the seesion.  |
