...
| set_id_token_original_header         | boolean  | False    | true                  |              | If true and if the ID token is available, set the value in the `X-ID-Token-Original` request header. In contrast to the `X-ID-TOKEN` header, this header will keep the original JWT encoding (including JWT headers and JWS signature).                                                                                                                                                                                                                                                                                 |
