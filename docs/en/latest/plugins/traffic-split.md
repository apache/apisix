...
| ------------------------------ | ------------- | ----------- | ------- | ------- | ---------------------------------------------------------------------------------------- |
| rules.match                    | array[object] | optional    |         |  | List of matching rules. When `match` is configured, check whether `match` is passed according to the configuration information, otherwise, `match` is passed by default. |
