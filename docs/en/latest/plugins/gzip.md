...
| buffers.number | integer              | False    | 32            | >= 1         | Dynamically sets the `gzip_buffers` directive paramter `number`.                                          |
| buffers.size   | integer              | False    | 4096          | >= 1         | Dynamically sets the `gzip_buffers` directive paramter `size`. The unit is in bytes.                                          |
