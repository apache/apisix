...
| enable_degradation              | boolean  | optional                                | false       |                                                                     | Whether to enable plugin degradation When the limit-req function is temporarily unavailable. Allow requests to continue when the value is set to true, default false. |
