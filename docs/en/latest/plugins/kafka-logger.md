...
| max_req_body_bytes     | integer | False    | 524288         | >=1                   | Maximum request body allowed in bytes. Requst bodies falling within this limit will be pushed to Kafka. If the size exceeds the configured value, the body will be truncated before being pushed to Kafka.                                                                                                                                                                                                  |
