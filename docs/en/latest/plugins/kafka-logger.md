...
| api_version           | integer | optional    | 1               | [0, 1, 2]             | Produce API version in [lua-resty-kafka](https://github.com/doujiang24/lua-resty-kafka). Default `1` to match the upstream library. Use `2` for Apache Kafka 4.x (Kafka 4.x drops support for magic0 and magic1).                                                                                                                                                                                                                                                        |
