...
| producer_batch_size | integer | optional    | 1048576 | [0,...] | `batch_size` param in [lua-resty-kafka], unit is byte |
| producer_max_buffering | integer | optional    | 50000 | [1,...] | `max_buffering` param in [lua-resty-kafka], max buffer size, unit is message count |
| producer_time_linger | integer | optional    | 1 | [1,...] | `flush_time` param in [lua-resty-kafka], unit is second |
