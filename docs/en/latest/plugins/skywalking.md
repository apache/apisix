...
keywords:
  ...
  - SkyWalking
  - skywalking
description: This article will introduce how the API gateway Apache APISIX reports metrics to Apache SkyWalking (an open source APM) through the skywalking plugin.
---
<!--
#
