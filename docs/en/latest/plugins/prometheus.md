...
You can use the [Nginx variable](https://nginx.org/en/docs/http/ngx_http_core_module.html) to create `extra_labels`. See [add extra labels](/hub/prometheus#add-extra-labels-for-metrics).
