...
| timeout          | False                                    | Auxiliary   | Set the upstream timeout for connection, sending and receiving messages of the route. This option will overwrite the [timeout](#upstream) option which set in upstream configuration.                                                                                                                                                                                                                                                                                                               | {"connect": 3, "send": 3, "read": 3}              |
...
```shell
{
    ...
    "timeout": {                # Set the upstream timeout for connection, sending and receiving messages of the route.
        "connect": 3,
        "send": 3,
        "read": 3
    },
