...
| PUT    | /apisix/admin/routes/{id}        | {...}        | Creates a Route with specified id.                                                                                            |
...
| PUT    | /apisix/admin/upstreams/{id}        | {...}        | Creates an Upstream with specified id.                                                                                           |
...
| create_time                 | optional                                    | Epoch timestamp in second of the created time. If missing, this field will be populated automatically.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | 1602883670                                                                                                                                 |
| update_time                 | optional                                    | Epoch timestamp in second of the updated time. If missing, this field will be populated automatically.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | 1602883670                                                                                                                                 |
...
| PUT    | /apisix/admin/ssl/{id} | {...}        | Creates a resource with specified id.           |
...
| create_time | False    | Epoch timestamp in second of the created time. If missing, this field will be populated automatically.             | 1602883670 |
| update_time | False    | Epoch timestamp in second of the updated time. If missing, this field will be populated automatically.             | 1602883670 |
...
| PUT    | /apisix/admin/stream_routes/{id} | {...}        | Creates a Stream Route with specified id.       |
