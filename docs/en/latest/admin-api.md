...
| tls.client_cert             | optional, can't be used with `tls_id`       | Sets the client certificate while connecting to a TLS Upstream.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |                                                                                                                                            |
| tls.client_key              | optional, can't be used with `tls_id`       | Sets the client private key while connecting to a TLS Upstream.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |                                                                                                                                            |
| tls_id                      | optional, can't be used with `tls.client_cert` and `tls.client_key`       | Set the referenced [SSL](#ssl) id.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |                                                                                                                                            |
...
Or you can reference SSL object by `tls_id` to set SSL cert and key. The SSL object can be referenced only if the `type` field is 1. Only `cert` and `key` will be used in the SSL object.
