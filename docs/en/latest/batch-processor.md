...
| entries_max_size   | integer | optional    | 0    | [0,...] | Sets the maximum size of logs sent in each batch. When the size of logs reaches the set maximum, all logs will be automatically pushed to the HTTP/HTTPS service. entries_max_size will take effect when it is greater than 0. |
