...
| upstream.checks.active.http_method | string   | False    | "GET"                            |              | Request Method to be used for healthchecks. |
| upstream.checks.active.request_body | string   | False    | ""                            |              | Request Body to be used for healthchecks. |
