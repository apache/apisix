...
- [Apache APISIX Slack Channel](https://apisix.apache.org/docs/general/join/#join-the-slack-channel)
- [Ask questions on APISIX mailing list](https://apisix.apache.org/docs/general/join/#subscribe-to-the-mailing-list)
