...
Developed and donated by [API7.ai](https://api7.ai/), Apache APISIX is an open source, dynamic, scalable, and high-performance cloud native API gateway for all your APIs and microservices.
