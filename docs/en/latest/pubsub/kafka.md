...
Currently, we implement a relatively simple function to list offset (ListOffsets), fetch message (Fetch) function, does not support the Apache Kafka consumer group, can not be manage offset by Kafka.
...
- Unsupport batch data acquisition
