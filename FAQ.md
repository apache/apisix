...
* If the monitoring directory has data updates: etcd will return the new subscribed data (in milliseconds) immediately, and APISIX will update it to the memory cache.
