...
|uris     |True, can't be used with `uri`|Match Rules|The `uri` in the form of an empty list means that multiple different hosts are allowed, and match any one of them.|["/hello", "/word"]|
...
|hosts    |False, can't be used with `host` |Match Rules|The `host` in the form of an nonempty list means that multiple different hosts are allowed, and match any one of them.|{"foo.com", "*.bar.com"}|
...
|remote_addrs|False, can't be used with `remote_addr` |Match Rules|The `remote_addr` in the form of an nonempty list indicates that multiple different IP addresses are allowed, and match any one of them.|{"127.0.0.1", "192.0.0.0/8", "::1"}|
