...
| enable_encode | boolean | optional    |     true       |           [ true, false ]                  | Whether to escape the uri parameter in the signature, for example: `params1=hello%2Cworld` is escaped, `params2=hello,world` is not escaped. true: means to escape the uri parameter in the signature, false: not to escape the uri parameter in the signature. |
