...
|headers         |No| Forward to the new `headers` of the upstream, can set up multiple. If it exists, rewrite the header; if it does not exist, add the header; if the value is "null", delete it.|
