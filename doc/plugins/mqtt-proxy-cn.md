...
```shell
curl http://127.0.0.1:9080/apisix/admin/stream/routes/1 -H 'X-API-KEY: edd1c9f034335f136f87ad84b625c8f1' -X PUT -d '
{
...
```shell
$ curl http://127.0.0.1:2379/v2/keys/apisix/stream/routes/1 -X DELETE
```
