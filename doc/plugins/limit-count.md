...
| key            | string  | required             |         | ["remote_addr", "server_addr", "http_x_real_ip", "http_x_forwarded_for", "consumer_name"] | The Description of key should be the user specified key to limit the counts.                                                                                                                                                                                                                                                                   |
