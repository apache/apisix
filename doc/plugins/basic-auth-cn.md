...
```shell
$ curl http://127.0.0.2:9080/hellogo -i
...
```shell
$ curl -i -ubar:bar http://127.0.0.1:9080/hellogo
HTTP/1.1 401 Unauthorized
...
...
```shell
$ curl -i -ufoo:foo http://127.0.0.1:9080/hellogo
HTTP/1.1 401 Unauthorized
...
...
```shell
$ curl -i -ufoo:bar http://127.0.0.1:9080/hellogo
HTTP/1.1 200 OK
...
hello, foo!
...
