...
| grant_type              | enum    | 可选   | "urn:ietf:params:oauth:grant-type:uma-ticket" | ["urn:ietf:params:oauth:grant-type:uma-ticket"] |                                                              |
...
| policy_enforcement_mode | enum    | 可选   | "ENFORCING"                                   | ["ENFORCING", "PERMISSIVE"]                     |                                                              |
