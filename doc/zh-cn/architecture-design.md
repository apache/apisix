...
```shell
# create new Service
$ curl http://127.0.0.1:9080/apisix/admin/services/200 -H 'X-API-KEY: YOUR_OWN_API_TOKEN' -X PUT -d '
{
    "plugins": {
        "limit-count": {
            "count": 2,
...
curl http://127.0.0.1:9080/apisix/admin/routes/100 -H 'X-API-KEY: YOUR_OWN_API_TOKEN' -X PUT -d '
{
    "methods": ["GET"],
    "uri": "/index.html",
    "service_id": "200"
...
curl http://127.0.0.1:9080/apisix/admin/routes/101 -H 'X-API-KEY: YOUR_OWN_API_TOKEN' -X PUT -d '
{
    "methods": ["GET"],
    "uri": "/foo/index.html",
    "service_id": "200"
...
```shell
curl http://127.0.0.1:9080/apisix/admin/routes/102 -H 'X-API-KEY: YOUR_OWN_API_TOKEN' -X PUT -d '
{
    "uri": "/bar/index.html",
    "id": "102",
    "service_id": "200",
...
```json
curl http://127.0.0.1:9080/apisix/admin/upstreams/1 -H 'X-API-KEY: YOUR_OWN_API_TOKEN' -X PUT -d '
{
    "type": "roundrobin",
    "k8s_deployment_info": {
...
curl http://127.0.0.1:9080/apisix/admin/upstreams/2 -H 'X-API-KEY: YOUR_OWN_API_TOKEN' -X PUT -d '
{
    "type": "chash",
    "key": "remote_addr",
...
```shell
 curl http://127.0.0.1:9080/hash_on_cookie -H 'X-API-KEY: YOUR_OWN_API_TOKEN' -H "Cookie: sid=3c183a30cffcda1408daf1c61d47b274"
```
...
```shell
 curl http://127.0.0.1:9080/hash_on_header -H 'X-API-KEY: YOUR_OWN_API_TOKEN' -H "Content-Type: application/json"
```
...
$ curl http://127.0.0.1:9080/apisix/admin/consumers/1 -H 'X-API-KEY: YOUR_OWN_API_TOKEN' -X PUT -d '
{
    "username": "jack",
    "plugins": {
        "key-auth": {
...
curl -X PUT \
  ...
  -H 'X-API-KEY: YOUR_OWN_API_TOKEN' \
  -d '{
        "plugins": {
            "limit-count": {
                "time_window": 60,
...
```shell
curl https://{apisix_listen_address}/apisix/admin/global_rules -H 'X-API-KEY: YOUR_OWN_API_TOKEN'
```
