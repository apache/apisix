...
$ curl http://127.0.0.1:9080/apisix/admin/routes/2?ttl=60 -H 'X-API-KEY: YOUR_OWN_API_TOKEN' -X PUT -i -d '
{
    "uri": "/aa/index.html",
    "upstream": {
        "type": "roundrobin",
...
$ curl http://127.0.0.1:9080/apisix/admin/routes/1 -H 'X-API-KEY: YOUR_OWN_API_TOKEN' -X PATCH -i -d '
{
    "upstream": {
        "nodes": {
            "39.97.63.216:80": 1
...
$ curl http://127.0.0.1:9080/apisix/admin/routes/1/upstream/nodes -H 'X-API-KEY: YOUR_OWN_API_TOKEN' -X PATCH -i -d '
{
    "39.97.63.200:80": 1
}'
HTTP/1.1 200 OK
...
$ curl http://127.0.0.1:9080/apisix/admin/routes/1/methods -H 'X-API-KEY: YOUR_OWN_API_TOKEN' -X PATCH -i -d '["POST", "DELETE", "PATCH"]'
HTTP/1.1 200 OK
...
...
```shell
# 创建一个Service
$ curl http://127.0.0.1:9080/apisix/admin/services/201  -H 'X-API-KEY: YOUR_OWN_API_TOKEN' -X PUT -i -d '
{
    "plugins": {
        "limit-count": {
            "count": 2,
...
$ curl http://127.0.0.1:9080/apisix/admin/services/201 -H 'X-API-KEY: YOUR_OWN_API_TOKEN' -X PATCH -i -d '
{
    "upstream": {
        "nodes": {
            "39.97.63.216:80": 1
...
$ curl http://127.0.0.1:9080/apisix/admin/services/201/upstream/nodes -H 'X-API-KEY: YOUR_OWN_API_TOKEN' -X PATCH -i -d '
{
    "39.97.63.200:80": 1
}'
HTTP/1.1 200 OK
...
$ curl http://127.0.0.1:9080/apisix/admin/consumers/2  -H 'X-API-KEY: YOUR_OWN_API_TOKEN' -X PUT -i -d '
{
    "username": "jack",
    "plugins": {
        "key-auth": {
...
```shell
# 创建一个upstream
$ curl http://127.0.0.1:9080/apisix/admin/upstreams/100  -H 'X-API-KEY: YOUR_OWN_API_TOKEN' -i -X PUT -d '
{
    "type":"roundrobin",
    "nodes":{
        "127.0.0.1:80":1,
...
$ curl http://127.0.0.1:9080/apisix/admin/upstreams/100 -H 'X-API-KEY: YOUR_OWN_API_TOKEN' -X PATCH -i -d '
{
    "nodes": {
        "39.97.63.216:80": 1
    }
...
# 替换 Upstream 的  nodes
$ curl http://127.0.0.1:9080/apisix/admin/upstreams/100/nodes -H 'X-API-KEY: YOUR_OWN_API_TOKEN' -X PATCH -i -d '
{
    "39.97.63.200:80": 1
}'
HTTP/1.1 200 OK
