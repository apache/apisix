...
>The environment variable TEST_NGINX_BINARY can set the execution path of nginx,such as TEST_NGINX_BINARY=/usr/local/bin/openresty prove -Itest-nginx/lib -r t
