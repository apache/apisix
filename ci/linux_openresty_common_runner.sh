...
script() {
    ...
    FLUSH_ETCD=1 prove -Itest-nginx/lib -I./ -r t/plugin/serverless-openresty-1-19.t | tee /tmp/test.result
    rerun_flaky_tests /tmp/test.result || cat t/servroot/logs/error.log
}
