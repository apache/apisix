...
echo 'set env KUBERNETES_SERVICE_HOST='${KUBERNETES_SERVICE_HOST}
echo 'set env KUBERNETES_SERVICE_PORT='${KUBERNETES_SERVICE_PORT}
echo 'set env KUBERNETES_CLIENT_TOKEN='${KUBERNETES_CLIENT_TOKEN}
echo 'set env KUBERNETES_CLIENT_TOKEN_FILE='${KUBERNETES_CLIENT_TOKEN_FILE}
