...
--- error_code: 400
--- response_body
{"error_msg":"invalid configuration: property \"trace_plugins\" validation failed: wrong type: expected object, got string"}
...
=== TEST 9: create route with excluded_plugins configuration
--- config
    location /t {
        content_by_lua_block {
            local t = require("lib.test_admin").test
                ...
                [[{
                    ...
                    "plugins": {
                        "opentelemetry": {
                            ...
                            "trace_plugins": {
                                "enabled": true,
                                "excluded_plugins": ["proxy-rewrite"]
                            }
                        },
                        "proxy-rewrite": {
                            "uri": "/get"
...
=== TEST 11: create route with plugin_span_kind set to server
--- config
    location /t {
        content_by_lua_block {
            local t = require("lib.test_admin").test
...
=== TEST 13: test schema validation for plugin_span_kind enum
--- config
    location /t {
        content_by_lua_block {
            local t = require("lib.test_admin").test
...
--- error_code: 400
--- response_body
{"error_msg":"invalid configuration: property \"trace_plugins\" validation failed: property \"plugin_span_kind\" validation failed: matches none of the enum values"}
