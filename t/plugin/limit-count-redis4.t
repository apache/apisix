...
=== TEST 6: set route, with redis host, port and bad username and good password
--- config
    location /t {
        content_by_lua_block {
            local t = require("lib.test_admin").test
...
=== TEST 8: set route, with redis host, port and good username and bad password
--- config
    location /t {
        content_by_lua_block {
            local t = require("lib.test_admin").test
