...
=== TEST 27: llm_active_connections gauge is 0 after response denied by content moderation
--- config
    location /t {
        content_by_lua_block {
            local t = require("lib.test_admin").test
...
=== TEST 28: llm_active_connections gauge is 0 after response denied by content moderation (ai-proxy-multi)
--- config
    location /t {
        content_by_lua_block {
            local t = require("lib.test_admin").test
