...
=== TEST 13: enable limit count for mirror requests, with default quota
--- config
       location /t {
           content_by_lua_block {
               local t = require("lib.test_admin").test
...
=== TEST 15: enable limit count for mirror request, with redis policy
--- config
       location /t {
           content_by_lua_block {
               local t = require("lib.test_admin").test
...
=== TEST 17: enable limit count for mirror request, with redis-cluster policy
--- config
       location /t {
           content_by_lua_block {
               local t = require("lib.test_admin").test
                        ...
                        "plugins": {
                            "proxy-mirror": {
                               ...
                               "policy": "redis-cluster",
                                ...
                                "redis_cluster_name": "redis-cluster-10"
                            }
                        },
                        "upstream": {
                            "nodes": {
