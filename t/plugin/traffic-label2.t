...
=== TEST 21: rules carrying a property named like the internal cache key
--- config
    location /t {
        content_by_lua_block {
            local t = require("lib.test_admin").test
                    ...
                    "plugins": {
                        "traffic-label": {
                            "rules": [
                                {"_expr": true,
                                 "match": [ ["http_x_case", "==", "a"] ],
                                 "actions": [{"set_headers": {"X-server-id": 1}}]},
                                {"_expr": false,
                                 "match": [ ["http_x_case", "==", "b"] ],
                                 "actions": [{"set_headers": {"X-server-id": 2}}]},
                                {"_expr": null,
                                 "match": [ ["http_x_case", "==", "c"] ],
                                 "actions": [{"set_headers": {"X-server-id": 3}}]}
                            ]
                        }
                    }
                }]]
...
=== TEST 22: the rule with a truthy property still matches
--- request
GET /echo
--- more_headers
X-Case: a
...
=== TEST 23: the rule with a false property still matches
--- request
GET /echo
--- more_headers
X-Case: b
...
=== TEST 24: the rule with a null property still matches
--- request
GET /echo
--- more_headers
X-Case: c
