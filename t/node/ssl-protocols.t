...
--- exec
echo -n "Q"  | $OPENSSL3_BIN s_client -connect 127.0.0.1:1994 -servername test.com -tls1_3 2>&1 | cat
--- response_body eval
...
--- exec
echo -n "Q"  | $OPENSSL3_BIN s_client -connect 127.0.0.1:1994 -servername test.com -tls1_1 2>&1 | cat
--- response_body eval
qr/Server certificate/
...
--- exec
echo -n "Q"  | $OPENSSL3_BIN s_client -connect 127.0.0.1:1994 -servername test2.com -tls1_3 2>&1 | cat
--- response_body eval
qr/Server certificate/
