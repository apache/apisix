...
=== TEST 3: add key auth plugin using admin api
--- config
    location /t {
        content_by_lua_block {
            local t = require("lib.test_admin").test
...
--- exec
curl -k -v -H "Host: test.com" -H "content-length: 0" -H "apikey: 123" --http3-only --resolve "test.com:1994:127.0.0.1" https://test.com:1994/hello 2>&1 | cat
--- response_body eval
