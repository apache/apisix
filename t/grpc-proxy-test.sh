...
#set ssl
curl http://127.0.0.1:9080/apisix/admin/ssl/1  -H 'X-API-KEY: YOUR_API_KEY' -X PUT -d '
{
...
#delete test data
curl http://127.0.0.1:9080/apisix/admin/routes/1  -H 'X-API-KEY: YOUR_API_KEY' -X DELETE
curl http://127.0.0.1:9080/apisix/admin/ssl/1  -H 'X-API-KEY: YOUR_API_KEY' -X DELETE
