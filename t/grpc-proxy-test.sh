...
#set ssl
curl http://127.0.0.1:9080/apisix/admin/ssl/1  -H "X-API-KEY: $RANDOM_ADMIN_KEY" -X PUT -d '
{
...
#test grpc proxy
curl http://127.0.0.1:9080/apisix/admin/routes/1  -H "X-API-KEY: $RANDOM_ADMIN_KEY" -X PUT -d '
{
    "methods": ["POST"],
...
#delete test data
curl http://127.0.0.1:9080/apisix/admin/routes/1  -H "X-API-KEY: $RANDOM_ADMIN_KEY" -X DELETE
curl http://127.0.0.1:9080/apisix/admin/ssl/1  -H "X-API-KEY: $RANDOM_ADMIN_KEY" -X DELETE
